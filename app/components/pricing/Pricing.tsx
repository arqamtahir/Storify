...
export default function Pricing() {
  ...
  return (
    <div className="relative isolate bg-gradient w-full  px-3 py-16 sm:py-32 lg:px-8">
      <div
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className='text-dark'>
          Our plans are designed to help you grow your business and reach your goals.
          Our plans are designed to help you grow your business and reach your goals.
          Our plans are designed to help you grow your business and reach your goals.
          Our plans are designed to help you grow your business and reach your goals.
          Our plans are designed to help you grow your business and reach your goals.
